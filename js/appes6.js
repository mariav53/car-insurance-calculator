...
class Seguro {
  ...
  //metodo para hacer la cotización
  cotizarSeguro() {
    ...
    /* Si el seguro es básico se múltiplica por 30% mas y si es completo * 50% mas */
    if(this.tipo === 'basico') {
      cantidad *= 1.30;
    } else {
      cantidad *= 1.50;
...
// mensajes e informacion que se muestra
class Interfaz{
  ...
  mostrarResultado(seguro, total) {
    ...
    // Crear un div con la info de cotización
     const div = document.createElement('div');
...
//Generar las option del select con años
